...
/**
 * exem -  our file for execution - this is our main file
 ...
 * @argc: argument count
 * @argv: argument vector
 * Return: 1 when successful -1 when unsuccessful
 */
...
int main(int argc, char **argv)
{
	...
	char *prompt;
	size_t prompt_len;
	ssize_t prompt_mess, prompt_get;
	size_t line_size = 0;
	char *lineptr = NULL, *token, *token2;
	const char *delim = (" \n");
	char *lineptr_copy;
	int tokens_number, i;
